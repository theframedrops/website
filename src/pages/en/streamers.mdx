...
import Streamers from '@/components/content/Streamers.vue';
...
<a href={DISCORD_URL}>Join our Discord</a> and let us know you'd like to join! We'll add you to the list and help
you get setup.
