...
import tiltify_schedule_list from './tiltify_schedule_list.png';
import tiltify_schedule_items_options from './tiltify_schedule_items_options.png';
import upcoming_schedule from './upcoming_schedule.png';
import next_up_schedule from './next_up_schedule.png';
import full_schedule from './full_schedule.png';
...
<img src={tiltify_schedule_list} alt="A list of scheduled events in Titlify's dashboard"/>
...
<img src={tiltify_schedule_items_options} alt="Reward options screen"/>
...
To suggest an event to be added to the campaign, send a message to <a href={DISCORD_URL}>the #streamers channel in Discord</a> with your idea.
...
<img src={upcoming_schedule} alt='The donation page with "Next up on the schedule" listed in the info sidebar.'/>
...
<img src={next_up_schedule} alt="When an event is for the same day, it will show in said sidebar"/>
...
<img src={full_schedule} alt="The full schedule will open in a dialog and display the date and time events are occurring"/>
